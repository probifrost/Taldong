...
## 11. 포스터를 뜯어내면 나오는 간단한 고대시 수수께끼를 풀고, 그 해답과 관련된 장소를 뒤져 건전지를 찾는다.(단, 해당 장소를 비롯한 몇몇 장소는 이 시를 보기 전까지 별의별 핑계를 대서 확인하지 못하도록 제한을 걸자.) 
  ...
  (ex1 : 나는 어디에나 있다/나는 언제나 있다/ 나는 혼자인 동시에 여럿이다/나는 내 스스로 대화를 할 수 있다// 나는 누구인가?  ans1: 박진용선배의 필통에서 건전지를 찾는다)(ex2: 나는 지배자다/ 나는 올바르다/ 많은 사람들은 나를 찾는 이유는/내가 간직한 많은 금을 보기 위해서지 // 나는 누구인가?  ans2: 자가 담긴 통에서 건전지를 찾는다.) 
